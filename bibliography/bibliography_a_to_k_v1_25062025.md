...
**Purport:**<br>
They cite and stand on a 'Tantric Age' but don't interrogate and qualify it, though they cite, they fail to site their establishement, by taking the auspices and orient to lines-of-sight and the topology of the discourse and the nature of its environmental flows and processes, prior to setting their foundations and they commence their building with undue and unsound haste and hence, it destabilizes their position and premise from the outset. I feel I intend to proffer a loose sequence of circa five (5) -- though likely more -- tantric periods or discrete continua, that in a decantrilized way, are related to each other and not necessarily in a discrete linear relationships. I feal that the Himalayan Tantric doxological systems have virtues and yet it is of its own period and time and needs to be reworked into a Pan-lineal-inclusivity, yet contemporary model. Yet to be determined.
